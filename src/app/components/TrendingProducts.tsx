  ...
  return (
    <div className="w-full bg-white py-20">
        ...
        {products.map((product) => (
          <div key={product.id} className="group relative">
            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-[#3F509E] font-bold inline-block">$40.00</p>
      ...
      <div className="w-full max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Voucher 2 */}
        <div className="bg-pink-100 p-8 flex flex-col justify-between relative h-[200px]">
          <h3 className="text-[#3F509E] text-2xl font-bold mb-4">30% Off in all products</h3>
   {/* Button */}
          ...
          {exclusiveProducts.map((product) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-[#3F509E] font-bold inline-block">$52.00</p>
              </div>
            </div>
          ))}
        </div>
